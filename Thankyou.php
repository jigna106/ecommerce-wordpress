...
<div class="container">
  ...
  <div class="row">
    <div class="d-flex flex-row  mb-3">
      ...
      <div class="p-3 text-secondary border-end ">Date
        <div class="text-dark"><?php echo date(" jS F Y ") . "<br>"; ?></div>
      </div>
  ...
  <div class="row">
    ...
    <div><?php echo $order['address2'] . " " . $order['state'] . "," . $order['zip']; ?></div>
