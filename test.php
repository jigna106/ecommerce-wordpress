            ...
            <div class="col-lg-8 border p-3 main-section bg-white">
                ...
                <div class="row m-0">
                    <div class="col-lg-4 left-side-product-box pb-3">
                        ...
                        <img src="<?php echo get_the_post_thumbnail_url(get_the_ID(), 'full') ?>" class="border p-3" />
                    </div>
                    <div class="col-lg-8">
                        <div class="right-side-pro-detail border p-3 m-0">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <h6>Quantity :</h6>
                                    <input type="number" class="form-control text-center w-100" id="quantity" name="quantity"
                                        min="1" />
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 pb-2">
                                            ...
                                            <a href="<?php echo get_permalink(94); ?>"><input type="submit" name="submit"
                                                    value="ADD TO CART" class="btn btn-secondary" /></a>
                                        </div>
