            ...
            <tr>
              <td style="margin:0;padding:0">
                  ...
                  <tbody>
                    <tr>
                      <td valign="top" align="center" width="100" style="background-color:#ffffff">
                        <img alt="Swiggy" style="width:134px" src="<?php echo get_theme_file_uri('assets/images/logo1.png'); ?>" />
                      </td>
                    </tr>
                  </tbody>
                </table>
                  ...
                  <tbody>
                    <tr>
                      <td valign="top" width="100">
                        ...
                        <p>Delivery status:<span style="font-size:18px;font-weight:bold">
                            <!-- 6-7 working days  -->
                            <?php
                            $name = $post->post_name;
                            ...
                            if ($post->post_status == 'pending_payment') {
                              echo nl2br("Your Order has been shipped from the warehouse but payment pending.\n\n Expected Delivery:  6-7 working days.");
                ...
                <tfoot>
                  ...
                  <tr>
                    <th scope="row" colspan="2" style="text-align:right;background:#efefef;text-align:right;border-left:1px solid #eee;border-bottom:1px solid #eee;border-right:0;border-top:0">
                      Order Total</th>
                  ...
                  <tbody>
                    <tr>
                      <td valign="top">
                        ...
                        <p style="margin:0;margin-bottom:10px;padding:0;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
